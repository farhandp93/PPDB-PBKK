  ...
  <head>
    ...
    <title>PPDB Online SMA Negeri 2050</title>
  ...
  <body>
    <header>
      <nav class="navbar navbar-expand-lg shadow-sm">
        <div class="container py-2">
          ...
          <span class="navbar-brand ms-2 mb-0 h1">PPDB Online SMA Negeri 2050</span>
    ...
    <main>
      <div class="container pt-4">
        <h1 class="display-6">Pendaftaran Tahun Ajaran 2050</h1>
        <div class="row pt-4">
